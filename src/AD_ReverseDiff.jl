...
function logdensity(::Type{ValueGradient}, fℓ::ReverseDiffLogDensity, x::AbstractVector)
...
function logdensity(::Type{ValueGradient}, fℓ::ReverseDiffTapeLogDensity, x::AbstractVector)
